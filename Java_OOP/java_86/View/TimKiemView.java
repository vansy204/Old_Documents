...
import java_86.Controller.TimKiemListener;
import java_86.Model.TimKiemModel;
...
public class TimKiemView extends JFrame {
    ...
    public void setJlabelVanBan(){
        ...
        vanBanArea = new JTextArea(100,100);
        vanBanArea.setFont(font);
        jScrollPane = new JScrollPane(vanBanArea,JScrollPane.VERTICAL_SCROLLBAR_NEVER,JScrollPane.HORIZONTAL_SCROLLBAR_NEVER);
